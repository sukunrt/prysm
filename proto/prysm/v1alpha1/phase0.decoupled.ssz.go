...
func (c *BeaconState) MarshalSSZTo(dst []byte) ([]byte, error) {
	...
	for _, o := range c.PreviousEpochAttestations {
		if dst, err = o.MarshalSSZTo(dst); err != nil {
			return nil, fmt.Errorf("PreviousEpochAttestations: %w", err)
		}
	}
	...
	for _, o := range c.CurrentEpochAttestations {
		if dst, err = o.MarshalSSZTo(dst); err != nil {
			return nil, fmt.Errorf("CurrentEpochAttestations: %w", err)
		}
	}
	return dst, err
}
...
func (c *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	// Field 15: PreviousEpochAttestations
	{
		...
		if len(sszSlice15) > 3 {
			...
			if startOffset == 0 {
				return fmt.Errorf("encountered invalid offset of 0 when decoding c.PreviousEpochAttestations")
			}
			if startOffset%4 != 0 {
			...
			if totalVarBytes < startOffset {
				return fmt.Errorf("list bytes too short to contain an offset when decoding c.PreviousEpochAttestations")
			}
			c.PreviousEpochAttestations = make([]*PendingAttestation, listLen)
			var tmpSlice []byte
			for i := uint64(0); i < listLen; i++ {
				...
				if i+1 != listLen {
					...
					if totalVarBytes < endOffset {
						return fmt.Errorf("offset %d points past the end of buffer when decoding c.PreviousEpochAttestations", endOffset)
					}
				}
				if endOffset < startOffset {
					return fmt.Errorf("offset %d is not greater than start offset %d when decoding c.PreviousEpochAttestations", endOffset, startOffset)
				}
			...
			c.PreviousEpochAttestations = make([]*PendingAttestation, 0)
		}
	}
	...
	// Field 16: CurrentEpochAttestations
	{
		...
		if len(sszSlice16) > 3 {
			...
			if startOffset == 0 {
				return fmt.Errorf("encountered invalid offset of 0 when decoding c.CurrentEpochAttestations")
			}
			if startOffset%4 != 0 {
			...
			if totalVarBytes < startOffset {
				return fmt.Errorf("list bytes too short to contain an offset when decoding c.CurrentEpochAttestations")
			}
			c.CurrentEpochAttestations = make([]*PendingAttestation, listLen)
			var tmpSlice []byte
			for i := uint64(0); i < listLen; i++ {
				var tmp *PendingAttestation
				tmp = new(PendingAttestation)
				...
				if i+1 != listLen {
					...
					if totalVarBytes < endOffset {
						return fmt.Errorf("offset %d points past the end of buffer when decoding c.CurrentEpochAttestations", endOffset)
					}
				}
				if endOffset < startOffset {
					return fmt.Errorf("offset %d is not greater than start offset %d when decoding c.CurrentEpochAttestations", endOffset, startOffset)
				}
			...
			c.CurrentEpochAttestations = make([]*PendingAttestation, 0)
		}
	}
...
func (c *ENRForkID) MarshalSSZTo(dst []byte) ([]byte, error) {
	...
	if dst, err = c.NextForkEpoch.MarshalSSZTo(dst); err != nil {
		return nil, fmt.Errorf("NextForkEpoch: %w", err)
	}
...
func (c *ENRForkID) UnmarshalSSZ(buf []byte) error {
	...
	if err = c.NextForkEpoch.UnmarshalSSZ(sszSlice2); err != nil {
		return fmt.Errorf("NextForkEpoch: %w", err)
	}
	return err
}
...
func (c *ENRForkID) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field 2: NextForkEpoch
	if err := c.NextForkEpoch.HashTreeRootWith(hh); err != nil {
		return fmt.Errorf("NextForkEpoch: %w", err)
	}
	hh.Merkleize(indx)
	return nil
...
func (c *IndexedAttestation) UnmarshalSSZ(buf []byte) error {
	...
	// Field 0: AttestingIndices
	{
		...
		if numElem > 2048 {
			return fmt.Errorf("ssz-max exceeded: c.AttestingIndices has %d elements, ssz-max is 2048: %w", numElem, ssz.ErrListTooBig)
		}
...
func (c *PendingAttestation) MarshalSSZTo(dst []byte) ([]byte, error) {
	...
	if dst, err = c.InclusionDelay.MarshalSSZTo(dst); err != nil {
		return nil, fmt.Errorf("InclusionDelay: %w", err)
	}
...
func (c *PendingAttestation) UnmarshalSSZ(buf []byte) error {
	...
	if err = c.InclusionDelay.UnmarshalSSZ(sszSlice2); err != nil {
		return fmt.Errorf("InclusionDelay: %w", err)
	}
...
func (c *PendingAttestation) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field 2: InclusionDelay
	if err := c.InclusionDelay.HashTreeRootWith(hh); err != nil {
		return fmt.Errorf("InclusionDelay: %w", err)
	}
	// Field 3: ProposerIndex
	if err := c.ProposerIndex.HashTreeRootWith(hh); err != nil {
...
func (c *ProposerSlashing) MarshalSSZTo(dst []byte) ([]byte, error) {
	...
	if dst, err = c.Header_1.MarshalSSZTo(dst); err != nil {
		return nil, fmt.Errorf("Header_1: %w", err)
	}
	...
	if dst, err = c.Header_2.MarshalSSZTo(dst); err != nil {
		return nil, fmt.Errorf("Header_2: %w", err)
	}
...
func (c *ProposerSlashing) UnmarshalSSZ(buf []byte) error {
	...
	if err = c.Header_1.UnmarshalSSZ(sszSlice0); err != nil {
		return fmt.Errorf("Header_1: %w", err)
	}

	// Field 1: Header_2
	c.Header_2 = new(SignedBeaconBlockHeader)
	if err = c.Header_2.UnmarshalSSZ(sszSlice1); err != nil {
		return fmt.Errorf("Header_2: %w", err)
	}
	return err
}
...
func (c *Validator) MarshalSSZTo(dst []byte) ([]byte, error) {
	...
	if dst, err = c.ActivationEligibilityEpoch.MarshalSSZTo(dst); err != nil {
		return nil, fmt.Errorf("ActivationEligibilityEpoch: %w", err)
	}
	...
	if dst, err = c.ExitEpoch.MarshalSSZTo(dst); err != nil {
		return nil, fmt.Errorf("ExitEpoch: %w", err)
	}
...
func (c *Validator) UnmarshalSSZ(buf []byte) error {
	...
	if err = c.ActivationEligibilityEpoch.UnmarshalSSZ(sszSlice4); err != nil {
		return fmt.Errorf("ActivationEligibilityEpoch: %w", err)
	}
	...
	if err = c.ExitEpoch.UnmarshalSSZ(sszSlice6); err != nil {
		return fmt.Errorf("ExitEpoch: %w", err)
	}
...
func (c *Validator) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field 4: ActivationEligibilityEpoch
	if err := c.ActivationEligibilityEpoch.HashTreeRootWith(hh); err != nil {
		return fmt.Errorf("ActivationEligibilityEpoch: %w", err)
	}
	// Field 5: ActivationEpoch
	...
	// Field 6: ExitEpoch
	if err := c.ExitEpoch.HashTreeRootWith(hh); err != nil {
		return fmt.Errorf("ExitEpoch: %w", err)
	}
	// Field 7: WithdrawableEpoch
